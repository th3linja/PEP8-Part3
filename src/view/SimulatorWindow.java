...
public class SimulatorWindow extends Observable {
	...
	private JLabel srcCodeText = new JLabel("Source Code");
	private JTextArea srcCodeArea = new JTextArea();
	private JPanel srcCodePanel = new JPanel();
	...
	private JPanel buildSourceCodePanel() {
		srcCodePanel.setLayout(new BorderLayout());
		srcCodePanel.setPreferredSize(new Dimension(300, 200));
		srcCodePanel.setBorder(BorderFactory.createLineBorder(Color.black));
		srcCodeText.setBorder(BorderFactory.createLineBorder(Color.black));
		srcCodePanel.add(srcCodeText, BorderLayout.NORTH);
		srcCodeArea.setLineWrap(true);
		srcCodePanel.add(srcCodeArea, BorderLayout.CENTER);
		return srcCodePanel;
	}
	...
	public JTextArea getSrcCodeArea() {
		return srcCodeArea;
	}

	public void setSrcCodeArea(String binCode) {
		this.srcCodeArea.setText(binCode);
	}
